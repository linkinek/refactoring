...
public enum VehicleStatusEnum implements EnumClass<String>, CurrentState<VehicleStatusEnum> {
    ...
    OPEN("open", Lists.newArrayList(DELETE, VehicleStatusEnum.RESERVED)),
    SERVICE("service", Lists.newArrayList(OPEN)),
    ...
    RETURNED("returned", Lists.newArrayList(SERVICE, OPEN));
